  ...
  return (
    <Section className="flex max-md:flex-col items-start gap-4">
      <div className="flex-[3] flex flex-col gap-2">
        ...
        Hey! I&apos;m
        {" "}
           <span className="text-primary">Daryl Ngako 👋,</span>
          </h2>
        <h3 className=" m-0 text-3xl max-md:text-2xl font-caption">
          {/* <ChevronRight className=" text-4xl" /> */}
          &gt; <span className="text-primary">Software</span> engineer, web developer,and <span className="text-blue-700">Typescript </span>enthusiast.
          </h3>
        <p  className="text-base">
          ...
          <Link href="#">
            <Code className="inline-flex items-center gap-1">
              <TypescriptIcon size={16} className="inline" />Typescript
            </Code>
          </Link> , and
          ...
          </Link> to create web applications. Living in  <Code className="inline-flex items-center gap-1">
              <FlagCmrIcon size={16} className="inline" />Cameroon.
            </Code>
        </p>
      </div>
